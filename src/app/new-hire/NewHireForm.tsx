  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (error) {
        ...
        toast.error('Error al registrar el ingresante. Intent├í nuevamente.')
        return
      }
        ...
        <div className="card p-7 shadow-xl shadow-black/20">
          <div className="flex items-center gap-3 mb-7">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Complet├í los datos del nuevo empleado</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                disabled={loading}
                placeholder="Ej: Mar├¡a Gonz├ílez"
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                disabled={loading}
                placeholder="Ej: Agente de Atenci├│n al Cliente"
                className="form-input"
              />
            </div>
